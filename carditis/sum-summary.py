...
def main() -> int:
	...
	myocarditis_alpha = int(myocarditis_df["alpha"].sum())
	myocarditis_beta = int(myocarditis_df["beta"].sum())
	myocarditis_gamma = int(myocarditis_df["gamma"].sum())
	if myocarditis_alpha + myocarditis_beta + myocarditis_gamma != myocarditis_sum_count:
		print('[Warn] 心筋炎の件数合計が、因果関係評価の合計と一致しません。')
		print(f' Total: {myocarditis_sum_count}')
		print(f' alpha: {myocarditis_alpha}, beta: {myocarditis_beta}, gamma: {myocarditis_gamma}')

	pericarditis_alpha = int(pericarditis_df["alpha"].sum())
	pericarditis_beta = int(pericarditis_df["beta"].sum())
	pericarditis_gamma = int(pericarditis_df["gamma"].sum())
	if pericarditis_alpha + pericarditis_beta + pericarditis_gamma != pericarditis_sum_count:
		print('[Warn] 心膜炎の件数合計が、因果関係評価の合計と一致しません。')
		print(f' Total: {pericarditis_sum_count}')
		print(f' alpha: {pericarditis_alpha}, beta: {pericarditis_beta}, gamma: {pericarditis_gamma}')
	...
	summary_data = {
		...
		"carditis_issues": {
			...
			"issues_by_evaluated_result": {
				"myocarditis": {
					"alpha": myocarditis_alpha,
					"beta": myocarditis_beta,
					"gamma": myocarditis_gamma,
				},
				"pericarditis": {
					"alpha": pericarditis_alpha,
					"beta": pericarditis_beta,
